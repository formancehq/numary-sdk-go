...
Commit a batch of new transactions to the ledger
	...
	*/
	...
	RevertTransactionExecute(r ApiRevertTransactionRequest) (*_nethttp.Response, error)
}
...
func (r ApiRevertTransactionRequest) Execute() (*_nethttp.Response, error) {
...
// Execute executes the request
func (a *TransactionsApiService) RevertTransactionExecute(r ApiRevertTransactionRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
