...
AddMetadataOnTransaction Set the metadata of a transaction by its ID
 ...
 @return ApiAddMetadataOnTransactionRequest
*/
func (a *TransactionsApiService) AddMetadataOnTransaction(ctx _context.Context, ledger string, txid int64) ApiAddMetadataOnTransactionRequest {
	return ApiAddMetadataOnTransactionRequest{
		ApiService: a,
		ctx: ctx,
		ledger: ledger,
...
GetTransaction Get transaction from a ledger by its ID
 ...
 @return ApiGetTransactionRequest
*/
func (a *TransactionsApiService) GetTransaction(ctx _context.Context, ledger string, txid int64) ApiGetTransactionRequest {
	return ApiGetTransactionRequest{
		ApiService: a,
		ctx: ctx,
		ledger: ledger,
...
// Execute executes the request
//  @return TransactionsCursorResponse
func (a *TransactionsApiService) ListTransactionsExecute(r ApiListTransactionsRequest) (TransactionsCursorResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
RevertTransaction Revert a ledger transaction by its ID
 ...
 @return ApiRevertTransactionRequest
*/
func (a *TransactionsApiService) RevertTransaction(ctx _context.Context, ledger string, txid int64) ApiRevertTransactionRequest {
	return ApiRevertTransactionRequest{
		ApiService: a,
		ctx: ctx,
		ledger: ledger,
