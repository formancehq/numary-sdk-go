...
type LedgerApi interface {
	...
	*/
	AddMetadataOnTransaction(ctx _context.Context, ledger string, txid int64) ApiAddMetadataOnTransactionRequest
	...
	*/
	GetTransaction(ctx _context.Context, ledger string, txid int64) ApiGetTransactionRequest
	...
	*/
	...
	ListAccountsExecute(r ApiListAccountsRequest) (AccountsCursorResponse, *_nethttp.Response, error)
	...
	*/
	...
	ListTransactionsExecute(r ApiListTransactionsRequest) (TransactionsCursorResponse, *_nethttp.Response, error)
	...
	*/
	RevertTransaction(ctx _context.Context, ledger string, txid int64) ApiRevertTransactionRequest
...
AddMetadataOnTransaction Set the metadata of a transaction by its ID
 ...
 @return ApiAddMetadataOnTransactionRequest
*/
func (a *LedgerApiService) AddMetadataOnTransaction(ctx _context.Context, ledger string, txid int64) ApiAddMetadataOnTransactionRequest {
	return ApiAddMetadataOnTransactionRequest{
		ApiService: a,
		ctx: ctx,
		ledger: ledger,
...
func (a *LedgerApiService) AddMetadataOnTransactionExecute(r ApiAddMetadataOnTransactionRequest) (*_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LedgerApiService.AddMetadataOnTransaction")
	if err != nil {
...
AddMetadataToAccount Add metadata to an account
 ...
 @return ApiAddMetadataToAccountRequest
*/
func (a *LedgerApiService) AddMetadataToAccount(ctx _context.Context, ledger string, address string) ApiAddMetadataToAccountRequest {
	return ApiAddMetadataToAccountRequest{
		ApiService: a,
		ctx: ctx,
		ledger: ledger,
...
// Execute executes the request
func (a *LedgerApiService) AddMetadataToAccountExecute(r ApiAddMetadataToAccountRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LedgerApiService.AddMetadataToAccount")
	if err != nil {
		return nil, GenericOpenAPIError{error: err.Error()}
	}
...
CountAccounts Count the accounts from a ledger
 ...
 @return ApiCountAccountsRequest
*/
func (a *LedgerApiService) CountAccounts(ctx _context.Context, ledger string) ApiCountAccountsRequest {
	return ApiCountAccountsRequest{
		ApiService: a,
		ctx: ctx,
		ledger: ledger,
...
// Execute executes the request
func (a *LedgerApiService) CountAccountsExecute(r ApiCountAccountsRequest) (*_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LedgerApiService.CountAccounts")
	if err != nil {
		return nil, GenericOpenAPIError{error: err.Error()}
	}
...
CountTransactions Count the transactions from a ledger
 ...
 @return ApiCountTransactionsRequest
*/
func (a *LedgerApiService) CountTransactions(ctx _context.Context, ledger string) ApiCountTransactionsRequest {
	return ApiCountTransactionsRequest{
		ApiService: a,
		ctx: ctx,
		ledger: ledger,
...
// Execute executes the request
func (a *LedgerApiService) CountTransactionsExecute(r ApiCountTransactionsRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodHead
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LedgerApiService.CountTransactions")
	if err != nil {
		return nil, GenericOpenAPIError{error: err.Error()}
	}
...
CreateTransaction Create a new transaction to a ledger
 ...
 @return ApiCreateTransactionRequest
*/
func (a *LedgerApiService) CreateTransaction(ctx _context.Context, ledger string) ApiCreateTransactionRequest {
	return ApiCreateTransactionRequest{
		ApiService: a,
		ctx: ctx,
		ledger: ledger,
...
// Execute executes the request
//  @return TransactionsResponse
func (a *LedgerApiService) CreateTransactionExecute(r ApiCreateTransactionRequest) (TransactionsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LedgerApiService.CreateTransaction")
	if err != nil {
...
CreateTransactions Create a new batch of transactions to a ledger
 ...
 @return ApiCreateTransactionsRequest
*/
func (a *LedgerApiService) CreateTransactions(ctx _context.Context, ledger string) ApiCreateTransactionsRequest {
	return ApiCreateTransactionsRequest{
		ApiService: a,
		ctx: ctx,
		ledger: ledger,
...
// Execute executes the request
//  @return TransactionsResponse
func (a *LedgerApiService) CreateTransactionsExecute(r ApiCreateTransactionsRequest) (TransactionsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LedgerApiService.CreateTransactions")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
GetAccount Get account by its address
 ...
 @return ApiGetAccountRequest
*/
func (a *LedgerApiService) GetAccount(ctx _context.Context, ledger string, address string) ApiGetAccountRequest {
	return ApiGetAccountRequest{
		ApiService: a,
		ctx: ctx,
		ledger: ledger,
...
// Execute executes the request
//  @return AccountResponse
func (a *LedgerApiService) GetAccountExecute(r ApiGetAccountRequest) (AccountResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LedgerApiService.GetAccount")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
GetBalances Get the balances from a ledger's account
 ...
 @return ApiGetBalancesRequest
*/
func (a *LedgerApiService) GetBalances(ctx _context.Context, ledger string) ApiGetBalancesRequest {
	return ApiGetBalancesRequest{
		ApiService: a,
		ctx: ctx,
		ledger: ledger,
...
// Execute executes the request
//  @return BalancesCursorResponse
func (a *LedgerApiService) GetBalancesExecute(r ApiGetBalancesRequest) (BalancesCursorResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LedgerApiService.GetBalances")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
GetBalancesAggregated Get the aggregated balances from selected accounts
 ...
 @return ApiGetBalancesAggregatedRequest
*/
func (a *LedgerApiService) GetBalancesAggregated(ctx _context.Context, ledger string) ApiGetBalancesAggregatedRequest {
	return ApiGetBalancesAggregatedRequest{
		ApiService: a,
		ctx: ctx,
		ledger: ledger,
...
// Execute executes the request
//  @return AggregateBalancesResponse
func (a *LedgerApiService) GetBalancesAggregatedExecute(r ApiGetBalancesAggregatedRequest) (AggregateBalancesResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LedgerApiService.GetBalancesAggregated")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
GetInfo Show server information
 ...
 @return ApiGetInfoRequest
*/
func (a *LedgerApiService) GetInfo(ctx _context.Context) ApiGetInfoRequest {
	return ApiGetInfoRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ConfigInfoResponse
func (a *LedgerApiService) GetInfoExecute(r ApiGetInfoRequest) (ConfigInfoResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LedgerApiService.GetInfo")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
GetMapping Get the mapping of a ledger
 ...
 @return ApiGetMappingRequest
*/
func (a *LedgerApiService) GetMapping(ctx _context.Context, ledger string) ApiGetMappingRequest {
	return ApiGetMappingRequest{
		ApiService: a,
		ctx: ctx,
		ledger: ledger,
...
// Execute executes the request
//  @return MappingResponse
func (a *LedgerApiService) GetMappingExecute(r ApiGetMappingRequest) (MappingResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LedgerApiService.GetMapping")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
GetTransaction Get transaction from a ledger by its ID
 ...
 @return ApiGetTransactionRequest
*/
func (a *LedgerApiService) GetTransaction(ctx _context.Context, ledger string, txid int64) ApiGetTransactionRequest {
	return ApiGetTransactionRequest{
		ApiService: a,
		ctx: ctx,
		ledger: ledger,
...
// Execute executes the request
//  @return TransactionResponse
func (a *LedgerApiService) GetTransactionExecute(r ApiGetTransactionRequest) (TransactionResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LedgerApiService.GetTransaction")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
// Filter accounts by their balance asset
func (r ApiListAccountsRequest) BalanceAsset(balanceAsset string) ApiListAccountsRequest {
	r.balanceAsset = &balanceAsset
	return r
}
...
func (r ApiListAccountsRequest) Execute() (AccountsCursorResponse, *_nethttp.Response, error) {
...
List accounts from a ledger, sorted by address in descending order.
 ...
 @return ApiListAccountsRequest
*/
func (a *LedgerApiService) ListAccounts(ctx _context.Context, ledger string) ApiListAccountsRequest {
	return ApiListAccountsRequest{
		ApiService: a,
		ctx: ctx,
		ledger: ledger,
...
// Execute executes the request
//  @return AccountsCursorResponse
func (a *LedgerApiService) ListAccountsExecute(r ApiListAccountsRequest) (AccountsCursorResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LedgerApiService.ListAccounts")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
	...
	if r.balanceAsset != nil {
		localVarQueryParams.Add("balanceAsset", parameterToString(*r.balanceAsset, ""))
	}
...
List the logs from a ledger, sorted by ID in descending order.
 ...
 @return ApiListLogsRequest
*/
func (a *LedgerApiService) ListLogs(ctx _context.Context, ledger string) ApiListLogsRequest {
	return ApiListLogsRequest{
		ApiService: a,
		ctx: ctx,
		ledger: ledger,
...
// Execute executes the request
//  @return LogsCursorResponse
func (a *LedgerApiService) ListLogsExecute(r ApiListLogsRequest) (LogsCursorResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LedgerApiService.ListLogs")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiListTransactionsRequest) Execute() (TransactionsCursorResponse, *_nethttp.Response, error) {
...
List transactions from a ledger, sorted by txid in descending order.
 ...
 @return ApiListTransactionsRequest
*/
func (a *LedgerApiService) ListTransactions(ctx _context.Context, ledger string) ApiListTransactionsRequest {
	return ApiListTransactionsRequest{
		ApiService: a,
		ctx: ctx,
		ledger: ledger,
...
// Execute executes the request
//  @return TransactionsCursorResponse
func (a *LedgerApiService) ListTransactionsExecute(r ApiListTransactionsRequest) (TransactionsCursorResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LedgerApiService.ListTransactions")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
Get statistics from a ledger. (aggregate metrics on accounts and transactions)
 ...
 @return ApiReadStatsRequest
*/
func (a *LedgerApiService) ReadStats(ctx _context.Context, ledger string) ApiReadStatsRequest {
	return ApiReadStatsRequest{
		ApiService: a,
		ctx: ctx,
		ledger: ledger,
...
// Execute executes the request
//  @return StatsResponse
func (a *LedgerApiService) ReadStatsExecute(r ApiReadStatsRequest) (StatsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LedgerApiService.ReadStats")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiRevertTransactionRequest) DisableChecks(disableChecks bool) ApiRevertTransactionRequest {
	r.disableChecks = &disableChecks
	return r
}
...
RevertTransaction Revert a ledger transaction by its ID
 ...
 @return ApiRevertTransactionRequest
*/
func (a *LedgerApiService) RevertTransaction(ctx _context.Context, ledger string, txid int64) ApiRevertTransactionRequest {
	return ApiRevertTransactionRequest{
		ApiService: a,
		ctx: ctx,
		ledger: ledger,
...
// Execute executes the request
//  @return TransactionResponse
func (a *LedgerApiService) RevertTransactionExecute(r ApiRevertTransactionRequest) (TransactionResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LedgerApiService.RevertTransaction")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
	...
	if r.disableChecks != nil {
		localVarQueryParams.Add("disableChecks", parameterToString(*r.disableChecks, ""))
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
Deprecated
*/
func (a *LedgerApiService) RunScript(ctx _context.Context, ledger string) ApiRunScriptRequest {
	return ApiRunScriptRequest{
		ApiService: a,
		ctx: ctx,
		ledger: ledger,
...
//  @return ScriptResponse
// Deprecated
func (a *LedgerApiService) RunScriptExecute(r ApiRunScriptRequest) (ScriptResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LedgerApiService.RunScript")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
UpdateMapping Update the mapping of a ledger
 ...
 @return ApiUpdateMappingRequest
*/
func (a *LedgerApiService) UpdateMapping(ctx _context.Context, ledger string) ApiUpdateMappingRequest {
	return ApiUpdateMappingRequest{
		ApiService: a,
		ctx: ctx,
		ledger: ledger,
...
// Execute executes the request
//  @return MappingResponse
func (a *LedgerApiService) UpdateMappingExecute(r ApiUpdateMappingRequest) (MappingResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LedgerApiService.UpdateMapping")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
