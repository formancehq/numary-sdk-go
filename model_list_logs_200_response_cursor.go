...
// ListLogs200ResponseCursor struct for ListLogs200ResponseCursor
type ListLogs200ResponseCursor struct {
...
func NewListLogs200ResponseCursor(pageSize int64, data []Log) *ListLogs200ResponseCursor {
	this := ListLogs200ResponseCursor{}
...
func (o ListLogs200ResponseCursor) MarshalJSON() ([]byte, error) {
...
type NullableListLogs200ResponseCursor struct {
	value *ListLogs200ResponseCursor
	isSet bool
}

func (v NullableListLogs200ResponseCursor) Get() *ListLogs200ResponseCursor {
	return v.value
}

func (v *NullableListLogs200ResponseCursor) Set(val *ListLogs200ResponseCursor) {
	v.value = val
	v.isSet = true
}

func (v NullableListLogs200ResponseCursor) IsSet() bool {
	return v.isSet
}

func (v *NullableListLogs200ResponseCursor) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListLogs200ResponseCursor(val *ListLogs200ResponseCursor) *NullableListLogs200ResponseCursor {
	return &NullableListLogs200ResponseCursor{value: val, isSet: true}
}

func (v NullableListLogs200ResponseCursor) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListLogs200ResponseCursor) UnmarshalJSON(src []byte) error {
	v.isSet = true
